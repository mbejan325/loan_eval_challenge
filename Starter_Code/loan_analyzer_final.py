...
print(f"The total value of all the loans in the list is ${total_loan_value}")
...
if present_value > cost:
    print(f"This loan is worth more than its cost to buy, it is a good purchase.")
else:
...
def calculated_present_value(future_value, remaining_months, annual_discount_rate):
    "This calculates the present value of the new loan"
    present_value = future_value / (1 + (annual_discount_rate / 12)) ** remaining_months
    return present_value

present_value = calculated_present_value(
...
number_inexpensive_loans = len(inexpensive_loans)

# @TODO: Print the `inexpensive_loans` list
print(f"There are {number_inexpensive_loans} inexpensive loans, they are as follows: {inexpensive_loans}")
